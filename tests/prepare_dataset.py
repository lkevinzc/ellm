...
def main(
    dataset_name: str, model_name: str, push_to: str, write_token: str, commit_msg: str
):
    print(write_token)
    ...
    llm = vllm.LLM(model=model_name, tensor_parallel_size=1)
...
"""
python tests/prepare_dataset.py trl-internal-testing/tldr-preference-sft-trl-style@462bcbf9c2eb9d30b4a029c1ed561710a571398c cleanrl/EleutherAI_pythia-1b-deduped__sft__tldr lkevinzc/tldr-with-sft-reference $HF_WRITE_TOKEN "Add pythia-1b reference responses"
"""
